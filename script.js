...
// var city =document.querySelector('.weather_city');
// var day = document.querySelector('.weather_day');
// var tempreature = document.querySelector('.weather_indicator--tempreature>.value');
// var wind = document.querySelector('.weather_indicator--wind>.value');
// var humidity = document.querySelector('.weather_indicator--wind.value');
...
$('#search-form').on('submit', function(event) {
   ...
   console.log(city)
   var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+city+"&appid=da7f4aab324ce68fae9d4a040baf0bf0" 
